...
import { FaUser, FaEnvelope, FaLock, FaFacebook, FaArrowRight } from 'react-icons/fa';
...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate('/'); // Account ban-ne ke baad home ya dashboard par redirect karein
    } catch (err) {
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-start gap-2">
                <input
                  ...
                  className="w-4 h-4 accent-secondary rounded mt-1"
                  required
                />
            ...
            <div className="mt-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
              <p className="text-xs text-gray-500 text-center">
                🚀 Register to access your dashboard and manage your orders.
              </p>
            </div>
          </motion.div>
        </div>
